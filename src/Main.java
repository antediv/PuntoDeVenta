...
public class Main {
            ...
            switch (opcion) {
                case 1:
                    ...
                    if (usuarioLogueado != null) {
                        ...
                        System.out.println("Error: El usuario no existe o esta mal escrito.");
                    }
                    break;
                case 2:
    ...
    private static void menuAutenticado(Usuario user) {
        ...
        while (!cerrarSesion) {
            ...
            switch (opcion) {
                ...
                case 7:
                    cerrarSesion = true;
                    System.out.println("Cerrando sesion de " + user.getUserName());
                    break;
                case 8:
    ...
    private static void menuCesta(Usuario u) {
        ...
        while (!volver) {
            ...
            System.out.println("5. Generar Factura (si ya pago)");
